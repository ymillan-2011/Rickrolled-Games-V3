...
<html>
  ...
  <body>
        ...
        <div class="carousel-inner">
          ...
          <div class="item">
            <div class="flex-container">
              ...
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/Benenbotix.jpeg" alt="Benenbotix" />
                  <div class="card-body">
                    <h3>Benenbotix</h3>
                    <p class="card-text">
          ...
          <div class="item">
            <div class="flex-container">
              ...
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/SoupMario.png" alt="SoupMario" />
                  <div class="card-body">
                    <h3>SoupMario</h3>
                    <p class="card-text">
              ...
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/static.png" alt="static" />
                  <div class="card-body">
                    <h3>static</h3>
                    <p class="card-text">
              ...
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/mrbeast.png" alt="mrbeast" />
                  <div class="card-body">
                    <h3>Mr.Beast</h3>
                    <p class="card-text">
          ...
          <div class="item">
            <div class="flex-container">
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/Beaglez.png" alt="Beaglez" />
                  <div class="card-body">
                    <h3>Beaglez</h3>
                    <p class="card-text">
              ...
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/Urmom345.gif" alt="Urmom345" />
                  <div class="card-body">
                    <h3>Urmom345</h3>
                    <p class="card-text">
              ...
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/Funni.png" alt="Funni" />
                  <div class="card-body">
                    <h3>Funni man</h3>
                    <p class="card-text">
              ...
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/$wiftyIke.png" alt="$wiftyIke" />
                  <div class="card-body">
                    <h3>$wiftyIke</h3>
                    <p class="card-text">
          ...
          <div class="item">
            <div class="flex-container">
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/Vizual.png" alt="Vizual" />
                  <div class="card-body">
              ...
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/breakingbad.png" alt="Walter Hartwell White" />
                  <div class="card-body">
              ...
              <div class="card-wrapper">
                <div class="card text-center">
                  <img class="card-img-top" src="/img/reviews/PeanutMaster.png" alt="PeanutMaster"/>
                  <div class="card-body">
                    <h3>PeanutMaster</h3>
                    <p class="card-text">
    ...
    <p class="text-center">
      ...
      <a href="/dump/redirect.html?to=mailto%3Aecho-the-coder%40tuta.io&local=false">echo-the-coder@tuta.io</a> for information.
    </p>
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5756835229788588" crossorigin="anonymous"></script>
    <ins class="adsbygoogle" style="display: block;" data-ad-client="ca-pub-5756835229788588" data-ad-slot="6230603875" data-ad-format="auto" data-full-width-responsive="true"></ins>
    <script>
